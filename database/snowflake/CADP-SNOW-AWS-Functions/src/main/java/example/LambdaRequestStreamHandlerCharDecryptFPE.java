 ...
 * Format Preserve decryption (FPE) to maintain the original format of the data
 ...
 * combinations of decryption algorithms and IV, etc. Was tested with CM 2.14 &
...
public class LambdaRequestStreamHandlerCharDecryptFPE implements RequestStreamHandler {
	...
	public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
		...
		try {
			...
			snowflakereturnstring = formatReturnValue(statusCode, snowflakedata, false, decryptCipher);
