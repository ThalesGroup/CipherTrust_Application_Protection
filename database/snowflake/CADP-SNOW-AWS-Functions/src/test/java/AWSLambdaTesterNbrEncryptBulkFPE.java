...
public class AWSLambdaTesterNbrEncryptBulkFPE implements RequestStreamHandler {
	...
	public static void main(String[] args) throws Exception {
		AWSLambdaTesterNbrEncryptBulkFPE nw2 = new AWSLambdaTesterNbrEncryptBulkFPE();
	...
	public void handleRequest(String inputStream, OutputStream outputStream, Context context) throws IOException {
		...
		try {
			...
			if (returnciphertextbool) {
				if (e.getMessage().contains("1401") || (e.getMessage().contains("1001"))) {
