...
TEMPLATE_SQL_PATH = (
    r"E:\eclipse-workspace\thales.databricks.udf\sql_warehouse\deploy\create_uc_plaintext_protected_none_reveal_functions_and_views_embedded_config.sql"
)
OUTPUT_SQL_PATH = r"C:\tmp\create_uc_plaintext_protected_none_reveal_functions_and_views_embedded_config.sql"
