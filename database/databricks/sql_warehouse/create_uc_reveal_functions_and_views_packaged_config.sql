...
-- MAGIC %md
-- MAGIC # Unity Catalog SQL Warehouse Reveal Functions and Views - Packaged Config
-- MAGIC
-- MAGIC Purpose:
...
-- Replace `thales_udf_deployers` with the group or principal that should use these objects.
