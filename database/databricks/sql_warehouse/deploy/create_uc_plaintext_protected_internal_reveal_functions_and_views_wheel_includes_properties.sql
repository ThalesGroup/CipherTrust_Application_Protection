...
CREATE OR REPLACE FUNCTION my_catalog.my_schema.thales_reveal_by_object_and_column_uc(
  value STRING,
  datatype STRING,
  object_name STRING,
  column_name STRING,
...
CREATE OR REPLACE FUNCTION my_catalog.my_schema.thales_reveal_bulk_by_object_and_column_uc(
  values ARRAY<STRING>,
  datatype STRING,
  object_name STRING,
  column_name STRING,
...
SELECT
  custid,
  name,
  my_catalog.my_schema.thales_reveal_by_object_and_column_uc(
...
SELECT
  ...
  custid_array,
  name_array,
  my_catalog.my_schema.thales_reveal_bulk_by_object_and_column_uc(
...
GRANT EXECUTE ON FUNCTION my_catalog.my_schema.thales_reveal_by_object_and_column_uc TO `thales_udf_deployers`;
GRANT EXECUTE ON FUNCTION my_catalog.my_schema.thales_reveal_bulk_by_object_and_column_uc TO `thales_udf_deployers`;
