...
CREATE OR REPLACE FUNCTION my_catalog.my_schema.thales_reveal_bulk_by_object_and_column_uc_embedded(
  values ARRAY<STRING>,
  datatype STRING,
  object_name STRING,
  column_name STRING,
...
GRANT EXECUTE ON FUNCTION my_catalog.my_schema.thales_reveal_by_object_and_column_uc_embedded TO `thales_udf_deployers`;
GRANT EXECUTE ON FUNCTION my_catalog.my_schema.thales_reveal_bulk_by_object_and_column_uc_embedded TO `thales_udf_deployers`;
