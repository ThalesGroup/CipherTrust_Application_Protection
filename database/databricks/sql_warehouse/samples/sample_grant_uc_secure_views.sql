...
-- - these examples assume the current object-aware UC function names
--
-- Example principals:
...
GRANT EXECUTE ON FUNCTION main.security.thales_reveal_by_object_and_column_uc_embedded TO `thales_udf_deployers`;
GRANT EXECUTE ON FUNCTION main.security.thales_reveal_bulk_by_object_and_column_uc_embedded TO `thales_udf_deployers`;

-- Validation:
-- SHOW GRANTS ON VIEW main.security.v_customer_reveal;
-- SHOW GRANTS ON FUNCTION main.security.thales_reveal_by_object_and_column_uc_embedded;
-- SAMPLE: grant statements for the sample secure-view scripts
