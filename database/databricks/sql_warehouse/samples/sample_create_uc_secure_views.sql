...
-- - the object-aware `protect.object.<catalog>.<schema>.<table>` mappings exist
--   for the source token tables referenced below
...
SELECT
  ...
  customer_status,
  created_ts,
  main.security.thales_reveal_by_object_and_column_uc_embedded(
    email_token,
    'char',
    'main.raw.customer_tokens',
    'email',
...
SELECT
  customer_group_id,
  snapshot_ts,
  main.security.thales_reveal_bulk_by_object_and_column_uc_embedded(
    email_token_array,
    'char',
    'main.raw.customer_token_arrays',
    'email',
