...
-- MAGIC %md
-- MAGIC # Unity Catalog SQL Warehouse Reveal Functions and Views
-- MAGIC
-- MAGIC Purpose:
...
-- Replace `your_group` with the group or principal that should use these objects.
GRANT EXECUTE ON FUNCTION my_catalog.my_schema.thales_reveal_by_column_uc TO `your_group`;
GRANT EXECUTE ON FUNCTION my_catalog.my_schema.thales_reveal_bulk_by_column_uc TO `your_group`;

GRANT SELECT ON VIEW my_catalog.my_schema.v_plaintext_protected_internal_reveal_uc TO `your_group`;
GRANT SELECT ON VIEW my_catalog.my_schema.v_plaintext_protected_internal_array_reveal_uc TO `your_group`;
GRANT SELECT ON VIEW my_catalog.my_schema.v_plaintext_final_reveal_flat_uc TO `your_group`;
