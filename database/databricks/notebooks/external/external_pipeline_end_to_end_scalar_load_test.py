...
# MAGIC %md
# MAGIC # External Pipeline End-to-End Scalar Load Test
# MAGIC
# MAGIC This notebook is the end-to-end external scalar pipeline example for a
# MAGIC customer-like environment.
# MAGIC
# MAGIC It generates synthetic plaintext data, writes raw CSV files to ADLS Gen2,
# MAGIC loads those files into a Delta source table, and then runs
# MAGIC `external_scalar_object_aware_load.py`.
...
RAW_ADLS_PATH = "abfss://landing@mydatalake.dfs.core.windows.net/thales/load_test/plaintext_plaintext_external_raw/"
SOURCE_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_plaintext_external_load_test"
TARGET_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_protected_external_load_test"
...
RUN_NAME = "plaintext_external_pipeline_load_test"
...
HIGH_THROUGHPUT_NOTEBOOK_PATH = "./external_scalar_object_aware_load"
METRICS_HELPERS_NOTEBOOK_PATH = "../utils/perf_metrics_helpers"
BENCHMARK_MODE = True
LOAD_PATTERN = "pipeline_with_adls_scalar_object_aware_external"
...
# MAGIC %run ./external_scalar_object_aware_load

# COMMAND ----------

load_result = run_external_scalar_object_aware_load(
    source_table=SOURCE_TABLE,
    target_table=TARGET_TABLE,
...
append_perf_metrics(
    run_name=RUN_NAME,
    step_name="protect_external_table",
    row_count=ROW_COUNT,
