...
# MAGIC %md
# MAGIC # None Pipeline End-to-End Scalar Load Test
# MAGIC
# MAGIC This notebook is the end-to-end none/no-version scalar pipeline example
# MAGIC for a customer-like environment.
...
RAW_ADLS_PATH = "abfss://landing@mydatalake.dfs.core.windows.net/thales/load_test/plaintext_plaintext_none_raw/"
SOURCE_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_plaintext_none_load_test"
TARGET_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_protected_none_load_test"
...
RUN_NAME = "plaintext_none_pipeline_load_test"
...
HIGH_THROUGHPUT_NOTEBOOK_PATH = "./none_scalar_object_aware_load"
METRICS_HELPERS_NOTEBOOK_PATH = "../utils/perf_metrics_helpers"
BENCHMARK_MODE = True
LOAD_PATTERN = "pipeline_with_adls_scalar_object_aware_none"
...
# MAGIC %run ./none_scalar_object_aware_load

# COMMAND ----------

load_result = run_none_scalar_object_aware_load(
    source_table=SOURCE_TABLE,
    target_table=TARGET_TABLE,
