...
-- MAGIC %md
-- MAGIC # Numbers Reveal Cast-Back Examples (SQL)
-- MAGIC
-- MAGIC Purpose:
...
-- MAGIC - provide the SQL-only version of the focused numeric cast-back example
-- MAGIC
...
SELECT *
FROM temp_v_plaintext_protected_internal_reveal
LIMIT 10;
...
CREATE OR REPLACE TEMP VIEW temp_v_plaintext_protected_internal_array_reveal AS
SELECT
  batch_id,
  custid_array,
  name_array,
...
SELECT *
FROM temp_v_plaintext_protected_internal_array_reveal
LIMIT 10;

-- COMMAND ----------

CREATE OR REPLACE TEMP VIEW temp_v_plaintext_final_reveal_flat AS
SELECT
...
SELECT *
FROM temp_v_plaintext_final_reveal_flat
LIMIT 10;
