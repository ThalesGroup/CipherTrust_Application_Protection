...
# MAGIC %md
# MAGIC # Numbers Reveal Cast-Back Examples
# MAGIC
# MAGIC This notebook shows the recommended compute-cluster reveal and cast-back
# MAGIC pattern when:
...
# MAGIC
# MAGIC Use this notebook when you want the focused numeric cast-back example,
# MAGIC rather than the broader numeric smoke test.
# MAGIC
