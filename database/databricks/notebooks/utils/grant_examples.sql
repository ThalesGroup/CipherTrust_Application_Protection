...
GRANT SELECT ON TABLE my_catalog.my_schema.account_balance_numbers TO `thales_cluster_deployers`;
GRANT SELECT ON TABLE my_catalog.my_schema.account_balance_numbers_protected_internal TO `thales_cluster_deployers`;
GRANT SELECT ON TABLE my_catalog.my_schema.account_balance_numbers_protected_external TO `thales_cluster_deployers`;
