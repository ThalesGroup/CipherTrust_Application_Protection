...
# MAGIC %md
# MAGIC # Internal Pandas UDF Benchmark
# MAGIC
# MAGIC This is the helper-first compute-cluster benchmark for the new integration.
...
SOURCE_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_plaintext_pandas_parallelism_diag"
TARGET_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_protected_internal_pandas_parallelism_diag"
...
RUN_NAME = "plaintext_internal_pandas_udf_parallelism_diagnostic"
...
LOAD_PATTERN = "pandas_map_in_pandas_parallelism_diagnostic"
PROTECT_STEP_NAME = "protect_internal_table_pandas_udf"
...
print(f"Generated and wrote Pandas diagnostic source Delta table in {generate_end - generate_start:.2f} seconds.")
