...
# MAGIC %md
# MAGIC # Internal Java UDF Bulk Array Benchmark
# MAGIC
# MAGIC This is the Java jar / UDF benchmark for the new integration.
...
SOURCE_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_plaintext_java_udf_parallelism_diag"
TARGET_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_protected_internal_java_udf_parallelism_diag"
...
RUN_NAME = "plaintext_internal_java_udf_bulk_parallelism_diagnostic_auto_tuned"
...
LOAD_PATTERN = "java_udf_bulk_array_parallelism_diagnostic_auto_tuned"
PROTECT_STEP_NAME = "protect_internal_table_java_udf_bulk"
...
print(f"Generated and wrote Java UDF diagnostic source Delta table in {generate_end - generate_start:.2f} seconds.")
