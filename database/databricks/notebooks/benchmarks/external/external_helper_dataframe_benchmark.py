...
# MAGIC %md
# MAGIC # External Helper DataFrame Benchmark
# MAGIC
...
TARGET_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_protected_external_helper_parallelism_diag"
...
RUN_NAME = "plaintext_external_helper_dataframe_parallelism_diagnostic"
...
LOAD_PATTERN = "external_helper_dataframe_parallelism_diagnostic"
PROTECT_STEP_NAME = "protect_external_table_helper_dataframe"
