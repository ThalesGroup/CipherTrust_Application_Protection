...
# MAGIC %md
# MAGIC # None Helper DataFrame Benchmark
# MAGIC
...
# MAGIC but it exercises the new Python wheel and `protect_dataframe(...)` path
...
# MAGIC
# MAGIC - This notebook does **not** require a jar in `target/`
...
TARGET_TABLE = f"{CATALOG}.{SCHEMA}.plaintext_protected_none_helper_parallelism_diag"
...
RUN_NAME = "plaintext_none_none_helper_dataframe_parallelism_diagnostic"
...
LOAD_PATTERN = "none_helper_dataframe_parallelism_diagnostic"
PROTECT_STEP_NAME = "protect_none_table_helper_dataframe"
...
print(f"Generated and wrote external helper diagnostic source Delta table in {generate_end - generate_start:.2f} seconds.")
...
print_settings_section(
    "Active helper benchmark controls:",
    {
        "row_count": ROW_COUNT,
...
print_settings_section(
    "Derived effective tuning controls:",
    {
        ...
        "estimated_helper_row_groups": ESTIMATED_GROUP_COUNT,
    },
)
