...
-- - retained for historical explanation/examples
-- - not intended to be run as the current supported notebook flow
--
...
-- - current supported examples prefix TEMP VIEW names with `temp_`
--
