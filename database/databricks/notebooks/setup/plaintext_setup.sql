...
SELECT
  ...
  collect_list(row_struct.custid) AS custid_array,
  collect_list(row_struct.name) AS name_array,
  collect_list(row_struct.address) AS address_decrypted,
  collect_list(row_struct.city) AS city_array,
  collect_list(row_struct.state) AS state_array,
  collect_list(row_struct.zip) AS zip_array,
  collect_list(row_struct.phone) AS phone_array,
  collect_list(row_struct.email) AS email_decrypted,
  collect_list(row_struct.dob) AS dob_array,
  collect_list(row_struct.creditcard) AS creditcard_decrypted,
  collect_list(row_struct.creditcardcode) AS creditcardcode_decrypted,
  collect_list(row_struct.ssn) AS ssn_decrypted
FROM batched_rows
GROUP BY batch_id;
