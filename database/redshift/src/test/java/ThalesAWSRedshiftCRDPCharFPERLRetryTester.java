...
public class ThalesAWSRedshiftCRDPCharFPERLRetryTester implements RequestStreamHandler {
	private static final Logger logger = Logger.getLogger(ThalesAWSRedshiftCRDPCharFPERLRetryTester.class.getName());
	private static final Gson gson = new Gson();
	private static final int MAX_RETRIES = 3;
	// private static final double REQUESTS_PER_SECOND = 5.0; // Adjust this rate as
	// needed
	private static final double REQUESTS_PER_SECOND = .00005; // Adjust this rate as needed

	private static final RateLimiter rateLimiter = RateLimiter.create(REQUESTS_PER_SECOND);

	public static void main(String[] args) throws Exception {

		ThalesAWSRedshiftCRDPCharFPERLRetryTester nw2 = new ThalesAWSRedshiftCRDPCharFPERLRetryTester();
		...
		nw2.handleRequest(protectrequest, null, null);
