...
public class ThalesAWSRedshiftCADPCharEncryptFPERLRetryTester implements RequestStreamHandler {
    private static final Logger logger = Logger.getLogger(ThalesAWSRedshiftCADPCharEncryptFPERLRetryTester.class.getName());
   ...
   // private static final double REQUESTS_PER_SECOND = 5.0; // Adjust this rate as needed
	...
	public static void main(String[] args) throws Exception {
		...
		ThalesAWSRedshiftCADPCharEncryptFPERLRetryTester nw2 = new ThalesAWSRedshiftCADPCharEncryptFPERLRetryTester();
