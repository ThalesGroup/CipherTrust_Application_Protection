 ...
 * 		passing in meta data during first EncryptUpdate/EncryptFinal call.
 * 5. Using the symmetric key to decrypt encrypted file;
 *    	passing in meta data during first DecryptUpdate/DecryptFinal call.
...
public class EncryptDecryptFileMeta {
    ...
    {
        System.out.println ("usage: java com.vormetric.pkcs11.sample.EncryptDecryptFileMeta -p pin -f path [-k keyName] [-m module]");
        System.exit (1);
    }
    ...
    public static void main ( String[] args) 
    {
		...
		try
	    {
            System.out.println ("Start EncryptDecryptFileMeta ..." );
            ...
            String metadata = "META: This is test meta data: Encryption: user: hostname";
            
            while ((len = in.read(inBuf)) > 0)

            {
            	outBuf = metadata.getBytes();
			...
			/* This is for user passed in logging data; format can be any string, recommend using JSON */
			metadata = "META: This is test meta data: Decryption: user: hostname";
            ...
            System.out.println ("End EncryptDecryptFileMeta." );
	    }
