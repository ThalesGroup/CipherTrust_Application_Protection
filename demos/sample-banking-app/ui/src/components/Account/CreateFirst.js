...
async function createAccountDetails(AccDetails) {
...
async function createAccountCard(AccDetails) {
...
export default function My() {
    ...
    const handleSubmit = async event => {
        ...
        const Account_details = await createAccountDetails({
            ssn,
            dob,
            fullName,
            userName,
        ...
        const Card_details = await createAccountCard({
            userName,
            accFriendlyName
        });
