            ...
            <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 pt-6 gap-8">
                    ...
                    <div className="w-full bg-white shadow rounded" id="modal">
                        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
                            <div className="flex items-center">
                                <div className="pl-3">
                                    <p className="text-lg font-medium leading-normal text-gray-800">Account Details</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="w-full bg-white shadow rounded" id="modal">
                        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
                            <div className="flex items-center">
                                <div className="pl-3">
                                    <p className="text-lg font-medium leading-normal text-gray-800">My Credit Accounts</p>
                                </div>
                            </div>
                        </div>
