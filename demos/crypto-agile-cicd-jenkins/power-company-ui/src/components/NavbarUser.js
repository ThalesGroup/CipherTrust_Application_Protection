    ...
    <nav className="bg-white dark:bg-gray-800 p-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex space-x-4">
          ...
          {/* <Link to="/smart-meters" className="text-gray-800 dark:text-white hover:text-blue-500">
            Smart Meters
          </Link> */}
          <Link to="/monthly-bills" className="text-gray-800 dark:text-white hover:text-blue-500">
            Monthly Bills
          </Link>
          <Link to="/usage-trend" className="text-gray-800 dark:text-white hover:text-blue-500">
            Usage Trend
          </Link>
        </div>
