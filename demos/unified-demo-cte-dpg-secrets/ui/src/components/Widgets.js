...
import { faAngleDown, faAngleUp, faCalendar, faChartArea, faChartBar, faChartLine, faFlagUsa, faFolderOpen, faGlobeEurope, faPaperclip, faUserPlus, faVoicemail } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        ...
        <Card.Subtitle className="fw-normal">Last contacted at: 01 January, 2024</Card.Subtitle>
