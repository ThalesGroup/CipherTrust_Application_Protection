        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                */
                ...
                Console.WriteLine("Please enter the passphrase for Persistent Cache");
                string passPhrase = Console.ReadLine();

                /* Create a new NAE Session using the username and password */
                session = new NaeSession(user, pass, passPhrase, propertyFilePath);
                ...
                //Not deleteing the key, as key will be saved in Persistent Cache file.
            }
            catch (Exception ex)
            {
