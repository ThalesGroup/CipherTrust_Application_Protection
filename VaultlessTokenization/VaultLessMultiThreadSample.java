...
/**
 * This sample shows how to use CADP Vaultless Tokenization
...
public class VaultLessMultiThreadSample extends Thread
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
        	...
        	//algospec.setUnicode(algospec.UNICODE_HEBREW);    //required when tokenizing unicode values
        	
        	
        	// START THE TOKEN SERVICE Vaultless by creating a new TokenServiceVaultless object
