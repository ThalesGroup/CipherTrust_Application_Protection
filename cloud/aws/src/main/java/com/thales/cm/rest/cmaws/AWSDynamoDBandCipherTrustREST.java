...
public class AWSDynamoDBandCipherTrustREST {
	...
	public static void main(final String[] args) throws Exception {
		...
		AWSDynamoDBandCipherTrustREST awsresrest = new AWSDynamoDBandCipherTrustREST();
		awsresrest.ctmh = new CipherTrustManagerHelper();

		if (args.length != 4) {
			System.err.println("Usage: java AWSDynamoDBandCipherTrustREST userid password keyname ctmip  ");
			System.exit(-1);
		}
