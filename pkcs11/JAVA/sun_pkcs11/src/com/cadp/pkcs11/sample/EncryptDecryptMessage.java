...
public class EncryptDecryptMessage {
    ...
    static void usage()
    {
        System.out.println("usage: java com.cadp.pkcs11.sample.EncryptDecryptMessage -p pin [-k keyName] [-m module] [-o operation {CTR | CBC_PAD (default) | CBC | FPE | FF1} ] [-L leftMost] [-R rightMost]");
