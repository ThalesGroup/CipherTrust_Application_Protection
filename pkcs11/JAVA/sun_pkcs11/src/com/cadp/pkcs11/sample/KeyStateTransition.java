...
public class KeyStateTransition {
    ...
    public static void usage() {
        System.out.println("usage: java [-cp CLASSPATH] com.cadp.pkcs11.sample.KeyStatesTransition -p pin [-m module]");
        ...
        System.out.println("-pt: Key stop date");
        System.exit(1);
    }
    ...
    public static void main ( String[] args)
    {
        ...
        try
        {
            ...
            {
                System.out.println ("The key is found on KeyManager:" + keyName);
