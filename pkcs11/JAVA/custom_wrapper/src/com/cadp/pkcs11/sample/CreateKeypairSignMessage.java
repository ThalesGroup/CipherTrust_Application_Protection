...
import com.cadp.pkcs11.wrapper.CK_ATTRIBUTE;
import com.cadp.pkcs11.wrapper.CK_MECHANISM;
import com.cadp.pkcs11.wrapper.PKCS11Exception;
...
public class CreateKeypairSignMessage {
    ...
    {
        System.out.println ("usage: java [-cp CLASSPATH] com.cadp.pkcs11.sample.CreateKeypairSignMessage -p pin [-m module] [-kp keypair_label]");
