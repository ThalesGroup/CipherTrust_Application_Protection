 ...
 * 7. Clean up.
 */
import static com.vormetric.pkcs11.wrapper.PKCS11Constants.CKM_AES_CBC;
import static com.vormetric.pkcs11.wrapper.PKCS11Constants.CKM_AES_CBC_PAD;
import static com.vormetric.pkcs11.wrapper.PKCS11Constants.CKM_AES_CTR;
...
public class EncryptDecryptMessage {
    ...
    static void usage()
    {
        ...
        System.out.println("       [-f 'inputtokenfile'] {[-c 'char set']|[-r 'charset file']|[-l 'literal charset file']} [-u utf-mode-name] [-d 'decryptedfile'] [-g genAction] [-ls lifespan] [-h headermode] [-a 'aad data'] [-t tagSize/tweak String] [-iu input utf-mode-name]");
