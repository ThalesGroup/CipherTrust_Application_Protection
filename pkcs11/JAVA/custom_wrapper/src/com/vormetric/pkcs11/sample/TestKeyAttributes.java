...
import static com.vormetric.pkcs11.wrapper.PKCS11Constants.CKA_MODULUS;
...
public class TestKeyAttributes {
    ...
    {
        System.out.println("usage: java [-cp CLASSPATH] com.vormetric.pkcs11.sample.TestKeyAttributes -p pin [-k Symmetric keyname] [-kp Asymmetric keyname] [-m module] [-b modulusBits] [-d days for key deactivation]");
        System.out.println("-p: Username:Password of Keymanager");
        System.out.println("-k: Symmetric keyname on Keymanager");
        System.out.println("-kp: Asymmetric keyname on Keymanager");
        System.out.println("-m: Path of directory where dll is deployed/installed");
        System.out.println("-b: ModulusBits");
        System.out.println("-d: days for key deactivation");
