...
/*
 ***************************************************************************
 * File: pkcs11_sample_create_key.h
 ***************************************************************************
 ***************************************************************************
 * pkcs11 sample create key header file
 ***************************************************************************
 */

#ifndef __pkcs11_sample_find_export_key_h__
#define __pkcs11_sample_find_export_key_h__

int findExportKeySample (int argc, char* argv[]);
/*
************************************************************************
* Function: findExportKeySample
* Calls the find export key sample
************************************************************************
* Returns: OK
************************************************************************
*/
