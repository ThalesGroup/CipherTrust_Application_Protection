...
//import com.vormetric.pkcs11.util.*;
...
public class EncryptDecryptMessage {
    ...
    static void usage()
    {
        System.out.println("usage: java com.vormetric.pkcs11.sample.EncryptDecryptMessage -p pin [-k keyName] [-m module] [-o operation {CTR | CBC_PAD (default) | CBC | FPE | FF1} ] [-L leftMost] [-R rightMost]");
        System.out.println("       [-f 'inputtokenfile'] {[-c 'char set']|[-r 'charset file']|[-l 'literal charset file']} [-u utf-mode-name] [-d 'decryptedfile'] [-g genAction] [-ls lifespan] [-h headermode]");
