 ...
 * 3. Registering a key or an opaque object on the Data Security Manager
 * 4. Clean up.
 ***************************************************************************
 */
...
{
    printf("Usage: vpkcs11_sample_create_object -p pin -s slotID {-k keyName | -kp keypair_name | -o opaqueObjectName} [-v keyVersion] [-dc creationDate] [-B basekey_identifier] [-m module] [-f binarykeyfile]\n");
