...
{
	printf ("Usage: vpkcs11_keypair_create_sign -p pin -s slotID -kp keyName [-b modulus_bit_size] [-m module]\n");
	printf ("-kp to be created keypair name");
	printf ("-b modulus bits size in bits");
	exit (2);
}
