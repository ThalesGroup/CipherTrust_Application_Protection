...
import com.vormetric.pkcs11.wrapper.PKCS11;
...
public class Helper {
    ...
    public static final long CKA_THALES_KEY_STATE_PREACTIVATED = ( CKA_THALES_DEFINED | 0x1001 );
    public static final long CKA_THALES_KEY_STATE_ACTIVATED = ( CKA_THALES_DEFINED | 0x1002 );
    public static final long CKA_THALES_KEY_STATE_SUSPENDED = ( CKA_THALES_DEFINED | 0x1003 );
    public static final long CKA_THALES_KEY_STATE_DEACTIVATED = ( CKA_THALES_DEFINED | 0x1004 );

    public static final long CKA_THALES_KEY_STATE_COMPROMISED = ( CKA_THALES_DEFINED | 0x1006 );
    public static final long CKA_THALES_KEY_STATE_DESTROYED = ( CKA_THALES_DEFINED | 0x1007 );

    public static final long CKA_THALES_KEY_STATE_ACTIONS = ( CKA_THALES_DEFINED | 0x0100 );
    public static final long CKA_THALES_OBJECT_CREATE_DATE = ( CKA_THALES_DEFINED | 0x1B );
    public static final long CKA_THALES_OBJECT_DESTROY_DATE	= ( CKA_THALES_DEFINED | 0x1C );
    ...
    public static final long CKA_THALES_KEY_ACTION_PROTECT_PROCESS = ( CKA_THALES_DEFINED | 0x0101 );
    public static final long CKA_THALES_KEY_ACTION_PROTECT_ONLY = ( CKA_THALES_DEFINED | 0x0102 );
    public static final long CKA_THALES_KEY_ACTION_PROCESS_ONLY = ( CKA_THALES_DEFINED | 0x0103 );
    ...
    public static final long CKA_KEY_CACHE_ON_HOST = ( CKA_VENDOR_DEFINED | 0x00000061 );
    public static final long CKA_KEY_CACHED_TIME = ( CKA_VENDOR_DEFINED | 0x00000063 );
    public static final long CKA_THALES_CACHE_CLEAR = ( CKA_VENDOR_DEFINED | 0x00000066 );;

    public static final long CKA_THALES_KEY_CACHED_TIME =  ( CKA_THALES_DEFINED | 0x63 );
    public static final long CKA_THALES_KEY_VERSION     =  ( CKA_THALES_DEFINED | 0x81 );
    public static final long CKA_THALES_KEY_VERSION_ACTION =   ( CKA_THALES_DEFINED | 0x82 );
    public static final long CKA_THALES_KEY_VERSION_LIFE_SPAN = ( CKA_THALES_DEFINED | 0x83 );

    public static final long CKA_THALES_DATE_OBJECT_CREATE  = CKA_THALES_DEFINED | 0x1B;

    public static final long CKA_THALES_VERSIONED_KEY  =  ( CKA_THALES_DEFINED | 0x85 );
    public static final long CKA_THALES_OBJECT_ALIAS   =  ( CKA_THALES_DEFINED | 0x86 );
    public static final long CKA_THALES_OBJECT_UUID    =  ( CKA_THALES_DEFINED | 0x87 );
    public static final long CKA_THALES_OBJECT_MUID    =  ( CKA_THALES_DEFINED | 0x88 );
    public static final long CKA_THALES_OBJECT_IKID    =  ( CKA_THALES_DEFINED | 0x89 );

    public static final long CKA_THALES_CUSTOM_DEFINED = CKA_THALES_DEFINED | 0x8000;
    public static final long CKA_THALES_CUSTOM_1 = CKA_THALES_CUSTOM_DEFINED | 0x01;
    public static final long CKA_THALES_CUSTOM_2 = CKA_THALES_CUSTOM_DEFINED | 0x02;
    public static final long CKA_THALES_CUSTOM_3 = CKA_THALES_CUSTOM_DEFINED | 0x03;
    public static final long CKA_THALES_CUSTOM_4 = CKA_THALES_CUSTOM_DEFINED | 0x04;
    public static final long CKA_THALES_CUSTOM_5 = CKA_THALES_CUSTOM_DEFINED | 0x05;

    public static final long CKA_THALES_DATE_OBJECT_CREATE_EL  = CKA_VORM_DEFINED | 0x1B;
    public static final long CKA_THALES_DATE_KEY_DEACTIVATION_EL = ( CKA_THALES_KEY_DEACTIVATION_DATE & 0X0FFFFFFF ) | CKA_VORM_DEFINED;
    ...
    public static void setKeyTransitionDates(Vpkcs11Session session, long keyID, ArrayList<CK_ATTRIBUTE> dateList) {
