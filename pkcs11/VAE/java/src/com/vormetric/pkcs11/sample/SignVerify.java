...
/***************************************************************************
 ** Copyright(c) 2017                           Confidential Material     **
 **                                                                       **
...
public class SignVerify {
    ...
    public static void usage() {
        System.out.println("usage: java [-cp CLASSPATH] com.vormetric.pkcs11.sample.SignVerify -p pin [-k keyName] [-o operation] [-m module] [-i message]");
    ...
    public static void main ( String[] args) {
        ...
        String keyName = "vpkcs11_java_sign_verify_test_key";
